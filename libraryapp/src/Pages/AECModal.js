                    ...
                    <div className={aec.modalBody}>
                        <div className={aec.nameSection} >
                            <div className={aec.comp1}>
                                <label className={aec.nameLabel}>Name:</label></div>
                            <div className={aec.comp2}>
                                <input className={aec.nameInput} type="text" value={name} onChange={(event) => { setName(event.target.value) }} /></div>
                            </div>
                        <div className={aec.maxCapSection} >
                            <div className={aec.comp1}>
                                <label className={aec.maxLabel} >Max Capacity:</label></div> 
                            <div className={aec.comp2}>
                                <input className={aec.maxInput} type="number" value={maxCapacity} onChange={(event) => { setMaxCapacity(event.target.value) }} /></div>
                            </div>
                        <div className={aec.levelSection} >
                            <div className={aec.comp1}>
                                <label className={aec.levelLabel}>Level:</label></div>
                            <div className={aec.comp2}>
                                <input className={aec.levelInput} type="number" value={level} onChange={(event) => { setLevel(event.target.value) }} /></div>
                            </div>
                        <div className={aec.descSection} >
                            <div className={aec.comp1}>
                                <label className={aec.descLabel}>Description:</label></div>
                            <div className={aec.comp2}>
                            <textarea className={aec.descInput} placeholder='Write the description of the space' type="text" value={description} onChange={(event) => { setDescription(event.target.value) }} /></div>
                            </div>
                        <div className={aec.statusSection} >
                            <div className={aec.comp1}>
                                <label className={aec.statusLabel}>Status:</label></div>
                            <div className={aec.comp2}>
