        ...
        const buttonFocusDelay = setInterval(() => {
            if (
                ...
                !buttonRefs.current.some(
                    (buttonRef) => buttonRef === document.activeElement
                )
            ) {
                ...
                <div className="info">
                    <div className="left-panel">
                        <div className="info-student">
                            <div className="stud-info" id="sec1-a"></div>
                            ...
                            <div className="stud-info" id="sec4-a"></div>
                            ...
                            <div className="stud-info" id="sec7-a"></div>
                                ...
                                <div className="reminder">
                                    <div className="note-div">
                                        <p>
                                            ...
                                            are correct before selecting your
                                            desired floor .
                                        </p>
                                    </div>
                    ...
                    <div className="fright-panel">
                        <div className="building-select">
                            ...
                            <div className="building-select2" id="sec2-b">
                                ...
                                <div className="comp" id="comp20"></div>
                            </div>
