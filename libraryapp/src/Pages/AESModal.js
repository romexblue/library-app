...
const StudentModal = ({ title, data, update, cancel, updateUi, action }) => {
    ...
    const handleConfirm = () => {
        if (action === "Edit") {
            ...
            axios
                .patch(
                    `${process.env.REACT_APP_API_URL}/student/${data.school_id}`,
                    dataChanged,
                    {
                        headers: {
                            accessToken: sessionStorage.getItem("accessToken"),
        ...
        if (action === "Add") {
            ...
            axios
                .post(`${process.env.REACT_APP_API_URL}/student/`, dataAdd, {
                    headers: {
                        accessToken: sessionStorage.getItem("accessToken"),
                        userId: sessionStorage.getItem("id"),
                    },
            ...
            <div className={aes.modal}>
                <div className={aes.modalContent}>
                    <div className={aes.modalHeader}>
                        ...
                        <div className={aes.modalClose} onClick={handleCancel}>
                            x
                        </div>
                    </div>
                    ...
                    <div className={aes.modalFooter}>
                        <button
                            className={aes.cancelBtn}
                            onClick={handleCancel}
                        >
                            Cancel
                        </button>
                        <button
                            className={aes.confirmBtn}
