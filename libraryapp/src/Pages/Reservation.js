...
function Reservation() {
    ...
    const getAvailableTime = (con, date) => {
        ...
        if (conId && date) {
            axios
                .get(
                    `${process.env.REACT_APP_API_URL}/reservation/${conId}/${newDate}`,
                    {
                        headers: {
                            accessToken: sessionStorage.getItem("accessToken"),
                            userId: sessionStorage.getItem("id"),
    ...
    const getConfabs = useCallback(() => {
        axios
            .get(`${process.env.REACT_APP_API_URL}/confab/all`, {
                headers: {
                    accessToken: sessionStorage.getItem("accessToken"),
                    userId: sessionStorage.getItem("id"),
                },
    ...
    function convertTo24Hour(params) {
        ...
        if (params === startTime) {
            //add 01 in minutes so adding new reservation will not conflict
        ...
        <>
                        ...
                        <div className="rcenterdiv">
                            <div className="rleft-panel">
                                <div className="component" id="c1">
                                    <p className="panel-title" id="pantitle1">
                                        Spaces
                                    </p>
                                </div>
                          ...
                          <p className="roomIcon"></p>
                            ...
                            <div className="rright-panel">
                                <div className="section" id="rsec1">
                                    ...
                                    <div className="comp" id="rcomp2"></div>
                                </div>
                                <div className="section" id="rsec2">
                                    <div className="Infosec" id="isec1">
                                        <div className="Infolabel" id="ilabel1">
                                            Date:
                                        </div>
                                        <div
                                            className="ConfInfo"
                                    ...
                                    <div className="Infosec" id="isec2">
                                        <div className="Infolabel" id="ilabel2">
                                            Room:
                                        </div>
                                        <div
                                            className="ConfInfo"
                                    ...
                                    <div className="Infosec" id="isec3">
                                        <div className="Infolabel" id="ilabel3">
                                            Capacity:
                                        </div>
                                        <div
                                            className="ConfInfo"
                                        ...
                                        >
                                            {`${
                                                selectedConfab.max_capacity
                                                    ? `${selectedConfab.max_capacity} pax`
                                                    : ""
                                            }`}{" "}
                                        </div>
                                    </div>
                                ...
                                <div className="section" id="rsec5">
                                    <div className="comp" id="drop1">
                                        Usage Time Range:
                                    </div>
                                    <div className="comp" id="drop2">
                                        <p className="errorReminder">
                                            {errorMessage}
                                        </p>
                                    </div>
                                </div>
            ...
            {!showForm && (
                <>
                    <ReservationUsers
                        confab={{
                            capacity: selectedConfab.max_capacity ?? 0,
                            name: selectedConfab.name ?? "",
                        }}
                        timeData={{
                            timeIn: startTime,
                            timeOut: endTime,
