...
function ReservationUsers({
    ...
    const handlePhoneNumberChange = (event) => {
        ...
        if (
            inputValue === "" ||
            (phoneNumberRegex.test(inputValue) && inputValue.length < 12)
        ) {
    ...
    const handleSubmit = async (event, index) => {
        ...
        if (!response.data) {
            ...
            if (studentData) {
                ...
                const isDuplicate = [...newInputValues, rep]
                    .filter((value, i) => i !== index && value !== "")
                    .includes(studentData.school_id);
                if (isDuplicate) {
                    const newInputValues = [...inputValues];
                    newInputValues[index] = "";
                    setInputValues(newInputValues);
                ...
                const nextIndex = newInputValues.findIndex(
                    (value, i) => i > index && value === ""
                );
                if (nextIndex >= 0 && inputRefs.current[nextIndex]) {
                    inputRefs.current[nextIndex].disabled = false;
                    inputRefs.current[nextIndex].setAttribute(
                        "placeholder",
                        "Scan Your ID or input School ID"
                    );
    ...
    const findStudent = async (id) => {
        const response = await axios.get(
            `${process.env.REACT_APP_API_URL}/student/find-one/${id}`,
            {
                headers: {
    ...
    for (let i = 0; i < counter - 1; i++) {
        inputFields.push(
            <form
                ...
                id="inputbox"
                key={i}
                onSubmit={(event) => handleSubmit(event, i)}
            >
                <label className="inputlabel">User {i + 2} *</label>
                <div className="inputCase">
                    <input
                        ...
                        placeholder={
                            i === 0 ? "Tap Your ID or input School ID" : ""
                        }
        ...
        <div className="rsmaindiv">
            <div className="rscenterdiv">
                <div className="rsleft-panel">
                    ...
                    <div className="section" id="rssec5"></div>
                    ...
                    <div className="section" id="rssec7">
                        <div className="partition" id="part4">
                            ...
                            <div className="comp" id="rscomp8">
                                <form
                                    onSubmit={(event) => submitRep(event)}
                                    className="inputHold"
                                >
                                    <input
                                        value={rep}
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        setRep("");
                                        repInputRef.current.disabled = false;
                                        setStudentData({});
                                    }}
                                >
                                    X
                        ...
                        <div className="partition" id="part5">
                            <div className="comp" id="rscomp9">
                                <p className="noteReminder">
                                    Click the Field and tap your ID on the
                                    reader. You may also type your ID number and
                                    press "Enter".
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="section" id="rssec10"></div>
                            ...
                            <div className="component" id="compo1">
                                ...
                                <div className="purpose" id="pinput">
                                    <textarea
                                        ...
                                        placeholder="Write the purpose of using the library space."
                                    />
                                </div>
                            </div>
                ...
                <div className="rsright-panel">
                    ...
                    <div className="section" id="rssec14">
                        <div className="inputnotes">
                            <p>
                                Select a field and tap your ID on the Card
                                Reader to add user. Alternately, you may
                                manually type the user’s school ID number and
                                Press "Enter".
                            </p>
                        </div>
