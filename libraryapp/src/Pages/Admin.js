...
const Admin = () => {
    ...
    const [activeComponent, setActiveComponent] = useState("AdminStatistics");
    ...
    return (
        <div className="main">
            <div className="sidebar">
                ...
                <div className="section" id="boundary"></div>
                ...
                <div className="section" id="sTime">
                    <div className="comp" id="timeDiv">
                        <div className="comp" id="timeContainer">
                            <div className="dateData" id="dateD">
                                {formatDate(date)}
                            </div>
                            <div className="dateData" id="timeDivider">
                                {" "}
                                |{" "}
                            </div>
                            <div className="dateData" id="timeD">
                                {" "}
                                {formatTime(date)}
                            </div>
                        </div>
            ...
            <div className="pagecontainer">
                <div className="navbar">
                    <div className="section" id="navbarPart1"></div>
