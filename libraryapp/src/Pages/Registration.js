...
const Registration = () => {
    ...
    const handleSubmit = () => {
        ...
        axios
            .put(`${process.env.REACT_APP_API_URL}/student/`, dataChanged, {
                headers: {
    ...
    const findStudent = (event) => {
        ...
        if (id.trim() !== "") {
            ...
            axios
                .get(`${process.env.REACT_APP_API_URL}/student/find-one/${encodedValue}`, {
                    headers: {
                        accessToken: sessionStorage.getItem("accessToken"),
                        userId: sessionStorage.getItem("id"),
                    },
        ...
        <div>
            ...
            <div className={reg.mainWindow}>
                ...
                <div className={reg.centerWindow}>
                    <div className={reg.windowTitle}>REGISTRATION WIZARD</div>
                                ...
                                <div className={reg.rightPanel}>
                                    ...
                                    <div className={reg.section4}>
                                        <div className={reg.compo1}>
                                            <label className={reg.label5}>
                                                College
                                            </label>
                                            <select
                                                disabled={searching}
                                                className={reg.input5}
                                                value={college}
                                        ...
                                        <div className={reg.compo2}>
                                            <label className={reg.label5a}>
                                                Type:
                                            </label>
                                            <select
                                                disabled={searching}
                                                required
                                                className={reg.statusSelect}
                                                value={type}
                                                onChange={(event) =>
                                            ...
                                            >
                                                ...
                                                <option value="SHSFACULTY">
                                                    SHS Faculty
                                                </option>
                                                <option value="STUDENT">
                                                    Student
                                                </option>
                                                <option value="SHSSTUDENT">
                                                    SHS Student
                                                </option>
                                                <option value="STAFF">
                                                    Staff
                                    ...
                                    <div className={reg.section5}>
                                        <div className={reg.comp3}>
                                            ...
                                            <input
                                                ...
                                                className={reg.input6}
                                                type="text"
                                            />
                                        </div>
                                        <div className={reg.comp4}>
                                            <label className={reg.label7}>
                                                Sex
                                            </label>
                                            <select
                                                disabled={searching}
                                                className={reg.input7}
                                                value={gender}
                                                onChange={(event) =>
                                                    setGender(
                                                        event.target.value
                        ...
                        <div className={reg2.formInput}>
                            ...
                            <div className={reg2.rightPanel}>
                                <div className={reg2.section1}>
                                    <label className={reg2.label1}>
                                        Personal Info
                                    </label>
                                    <div className={reg2.input1}>
                                        {schoolId}
                                    </div>
                                    <div
                                        className={reg2.input2}
                                    >{`${fName} ${lName}`}</div>
                                </div>
                                ...
                                <div className={reg2.section3}>
                                    ...
                                    />
                                    <p className={reg2.warningMessage}>
                                        {matchMessage}
                                    </p>
                                </div>
                            </div>
                            <div className={reg2.nxtButtonSection}>
                                <div className={reg2.sectionButtons}>
                                    <button
                                        className={reg2.backButton}
                                        onClick={() => nextPage()}
                                    >
                                        Back
                                    </button>
                                    <button
                                        className={reg2.nxtButton}
